    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_inicio', models.DateField(default=datetime.datetime(2022, 3, 24, 8, 55, 1, 908147))),
                ('data_termino', models.DateField(default=datetime.datetime(2022, 3, 24, 8, 55, 1, 908147))),
            ],
        ),
        migrations.CreateModel(
            name='Dinamica',
        ...
        migrations.AddField(
            model_name='candidato',
            name='vaga',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='main.vaga'),
        ),
        migrations.CreateModel(
